...
- [Free Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-soft-kit-1736784055) via `eMail` and `Discord`
...
```bash
$ git clone https://github.com/django-soft-kit-1736784055.git
$ cd django-soft-kit-1736784055
```
